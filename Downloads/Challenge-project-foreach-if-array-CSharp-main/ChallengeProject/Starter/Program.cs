    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 2] == "Age: ?" || ourAnimals[i, 4] == "Physical description: ")
                {
                    ...
                    if (ourAnimals[i, 2] == "Age: ?")
                    {
                        do
                        {
                            Console.WriteLine($"\n\rEnter a valid numeric age for {animalID}");
                            readResult = Console.ReadLine();
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (!int.TryParse(animalAge, out petAge) || string.IsNullOrWhiteSpace(animalPhysicalDescription))
                {
            ...
            if (allDataComplete)
            {
                Console.WriteLine("\n\rAll animal ages and physical descriptions are complete.");
            }
